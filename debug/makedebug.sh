#!/bin/bash
# 🔧 FIXED PEACOCK DEBUG VERSION

echo "🔧 Creating FIXED debug version..."

cat > pea-mcp-debug-FIXED.py << 'EOF'
#!/usr/bin/env python3
"""
...
class PeacockHandler(BaseHTTPRequestHandler):
    ...
    def execute_peacock_pipeline(self, user_input):
        ...
        try:
            ...
            orchestrator = OutHomingOrchestrator(session_timestamp=SESSION_TIMESTAMP)
...
echo "✅ Created pea-mcp-debug-FIXED.py"
echo ""
echo "🚀 Test the FIXED version:"
echo "   python3 pea-mcp-debug-FIXED.py --log"
echo ""
echo "This version properly calls orchestrate_full_pipeline() method!"