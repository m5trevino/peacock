...
LOCAL_LLM_URL = "http://localhost:11434/api/generate" # <-- Configured for Ollama generate endpoint

# Configure the specific model name you want to use from your Ollama list
LOCAL_LLM_MODEL_NAME = "llama2-uncensored:latest" # <-- Configured for your listed model
