	...
	####1/2 MARKER####
					...
					self.view.window().run_command("show_panel", {"panel": "output.peacock_explain"}						start_line_1based = suggested_change.get("start_line_1based", "??")
	...
	####END OF DOCUMENT####	# print("Peacock EIP: Captured location info: {}".format(location_info)) # Verbose logging
		return location_info
