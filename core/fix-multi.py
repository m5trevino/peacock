...
def process_llm_response(command, llm_raw_text, location_info, original_request=None):
    ...
    if command == "peacock_full" and original_request:
        try:
            ...
            # Files already auto-opened by generators, just log paths
            print(f"✅ XEdit interface saved: {xedit_reports_path}")
            print(f"✅ Model Dashboard saved: {dashboard_reports_path}")
