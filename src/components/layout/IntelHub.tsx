...
export const IntelHub: React.FC<IntelHubProps> = ({
    ...
    setInputs, setActivePrompts, executeStrike, sessionOutputs, initialTab
}) => {
                    ...
                    >
                        <div className="flex justify-between items-center border-b border-white/10 pb-10 mb-10">
                            <div className="flex items-center gap-6">
                                <div className="p-4 bg-white/5 rounded-xl border border-white/10" style={{ color: activeStageConfig.color }}>
                                    <span className="text-4xl">{activeStageConfig.icon}</span>
                                </div>
                                <div>
                                    <h3 className="text-4xl font-black italic tracking-tighter uppercase text-white">Mission_Start_Intel</h3>
                                    <p className="text-xs font-bold text-muted uppercase tracking-widest mt-2">{activeStageConfig.label} PHASE // ASSET SELECTION</p>
                                </div>
                            </div>
                            <button onClick={onClose} className="text-muted hover:text-white text-4xl transition-colors bg-white/5 w-16 h-16 rounded-xl flex items-center justify-center border border-white/5 hover:bg-error/20 hover:border-error/50 hover:text-error">✕</button>
                        </div>
